...
const interestedInUtils = {
    ...
    getAllInterests: async(data) => {
        ...
        // let { connection_type_id } = data;
        // if (connection_type_id == 'all') {
        //     let result = await getDataArray(Interests, { status: { $ne: 2 } }, '', );
        //     if (result.status) {
        //         return helpers.showResponse(true, Messages.DATA_FOUND_SUCCESS, result.data, null, 200);
        //     }
        //     return helpers.showResponse(false, Messages.DATA_NOT_FOUND, null, null, 200);
        // }
        // let connArray = [];
        // let connectionArray = connection_type_id.split(',');
        // for (var i = 0; i < connectionArray.length; i++) {
        //     connArray.push(ObjectId(connectionArray[i]))
        // }
        // let queryObject = { connection_type_id: { $in: connArray } }
        // result = await getDataArray(Interests, queryObject, '');
        // if (result.status) {
        //     return helpers.showResponse(true, Messages.DATA_FOUND_SUCCESS, result.data, null, 200);
        // }
        // return helpers.showResponse(false, Messages.DATA_NOT_FOUND, null, null, 200);
