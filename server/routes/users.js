...
router.post('/add_profile_gallery', middleware.checkToken, upload.fields([{ name: 'gallery_media', maxCount: 9 }]), UsersController.addProfileGallery);
...
router.post('/upload_profile_verifaction_images', middleware.checkToken, upload.fields([{ name: 'first_image', maxCount: 1 }, { name: 'second_image', maxCount: 1 }]), UsersController.uploadProfileVerificationImages);
