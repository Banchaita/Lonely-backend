...
router.post('/add_connection_type', middleware.checkAdminToken, upload.fields([{ name: 'connection_images', maxCount: 10 }]), InterestedInController.addConnectionType);
...
router.post('/add_verification_images', middleware.checkAdminToken, upload.fields([{ name: 'admin_first_image', maxCount: 1 }, { name: 'admin_second_image', maxCount: 1 }]), FaqController.addVerificationImages);
